...
function Resume() {
  return (
    <main className={styles.resume}>
      ...
      <Link 
        href='@/assets/Науменко Константин Николаевич - Full stak developer - cv.doc' 
        download={''} 
        target="_blank"
        className={styles['resume__file-link']}
      >
        <Image src={clip} alt={''} className={styles["resume__icon"]} />
        File
      </Link>
      <article className={styles["resume__contacts"]}>
        <Link className={styles["resume__number"]} href={'tel:+79133070592'}>
          +7 (913) 307-05-92
        </Link>
        <Link className={styles["resume__email"]} href={'mailto:thekostia5@gmail.com'}>
          thekostia5@gmail.com
        </Link>
        <Link className={styles["resume__site"]} href={'https://whostolemysleep.com'} target="_blank">
          whostolemysleep.com
        </Link>
      </article>
