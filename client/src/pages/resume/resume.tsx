...
function Resume() {
  ...
  return (
    <main className={styles.resume}>
      <h1 className={styles["resume__title"]}>
      ...
      <article className={styles["resume__contacts"]}>
        ...
        <Link
          ...
          to={"mailto:thekostia5@gmail.com"}
        >
          thekostia5@gmail.com
        </Link>
        <Link
          className={styles["resume__site"]}
          to={"https://whostolemysleep.ru/"}
          target="_blank"
        >
          whostolemysleep.ru
        </Link>
      ...
      <article className={styles["resume__about-me"]}>
        <h4 className={styles["resume__article-title"]}>{t("About Me")}</h4>
      ...
      <article className={styles["resume__experience"]}>
        <h4 className={styles["resume__article-title"]}>{t("Experience")}</h4>
      ...
      <article className={styles["resume__skills"]}>
        ...
        <ul className={styles["resume__skills-list"]}>
          ...
          <li className={styles["resume__frameworks"]}>
            ...
            <span className={styles["resume__all-learned"]}>
              React, Next.js, Angular, Node.js, Express, Laravel, Vue, Nuxt
            </span>
          </li>
          ...
          <li className={styles["resume__tools"]}>
            ...
            <span className={styles["resume__all-learned"]}>
              Git, MySQL, REST API, Graphql, Webpack, Jest, Redux, Mobx, Pinia,
              Figma
            </span>
          </li>
        </ul>
