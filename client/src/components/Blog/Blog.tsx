...
export default function Blog({blog}: {blog: {id: string, headImageLink: string, imagePosition: string, name: string, tags: string, text: string[], date: string, author: string}}) {
