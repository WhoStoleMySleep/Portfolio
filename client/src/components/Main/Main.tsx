  ...
  return (
    <main className={styles.main}>
      <div className="main__head-container">
        <img src={bgMain} alt={''} className={styles["main__background"]} loading='lazy' />
